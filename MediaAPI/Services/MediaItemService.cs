...
namespace MediaAPI.Services
{
    public class MediaItemService : IMediaItemService
    {
        ...
        public async Task<IEnumerable<MediaItemReadDto>> GetAllAsync()
        {
        ...
        public async Task<MediaItemReadDto?> GetByIdAsync(int id)
        {
            var m = await _context.MediaItems.FindAsync(id);
        ...
        public async Task<MediaItemReadDto> AddAsync(MediaItemCreateDto dto)
        {
            var m = new MediaItem
            {
        ...
        public async Task<MediaItemReadDto?> UpdateAsync(int id, MediaItemUpdateDto dto)
        {
            var m = await _context.MediaItems.FindAsync(id);
            if (m == null) return null;
